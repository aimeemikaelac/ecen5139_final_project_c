...
u32 XRunqueue_GetFullout(XRunqueue *InstancePtr) {
    ...
    Data = XRunqueue_ReadReg(InstancePtr->Axi4lites_BaseAddress, XRUNQUEUE_AXI4LITES_ADDR_FULLOUT_DATA);
    return Data;
}
...
u32 XRunqueue_GetCurrentiteration(XRunqueue *InstancePtr) {
    ...
    Data = XRunqueue_ReadReg(InstancePtr->Axi4lites_BaseAddress, XRUNQUEUE_AXI4LITES_ADDR_CURRENTITERATION_DATA);
    return Data;
}
...
u32 XRunqueue_GetTotal(XRunqueue *InstancePtr) {
    ...
    Data = XRunqueue_ReadReg(InstancePtr->Axi4lites_BaseAddress, XRUNQUEUE_AXI4LITES_ADDR_TOTAL_DATA);
    return Data;
}
